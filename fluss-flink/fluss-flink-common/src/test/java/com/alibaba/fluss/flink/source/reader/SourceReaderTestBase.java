...
/** Test for {@link SourceReader}. */
abstract class SourceReaderTestBase extends FlinkTestBase {

    public abstract SourceReader<RowData, SourceSplitBase> sourceReader(
    ...
    void testHandlePartitionsRemovedEvent() throws Exception {
        ...
        try (final SourceReader<RowData, SourceSplitBase> reader =
                createReader(
                        clientConf,
                        tablePath,
    ...
    private SourceReader<RowData, SourceSplitBase> createReader(
