...
public abstract class FlinkConversionsTestBase {

    private final CatalogTableFunction catalogTableFunction = catalogTableFunction();

    public abstract CatalogTableFunction catalogTableFunction();
    ...
    void testTableConversion() {
        ...
        CatalogTable convertedFlinkTable =
                FlinkConversions.toFlinkTable(tableInfo, catalogTableFunction());
