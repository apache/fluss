...
class SourceEnumeratorStateSerializerTest {
    ...
    void testPendingSplitsCheckpointSerde() throws Exception {
        ...
        Set<TableBucket> assignedLakeBuckets =
                new HashSet<>(Arrays.asList(new TableBucket(1, 2), new TableBucket(1, 5L, 3)));
        Map<Long, String> assignedLakePartitions = new HashMap<>();
        assignedLakePartitions.put(3L, "lakePartition1");
        assignedLakePartitions.put(4L, "lakePartition2");
