...
public abstract class AbstractTableSink
    ...
    protected final List<String> bucketKeys;
    protected final boolean shuffleByBucketId;
    protected final @Nullable DataLakeFormat lakeFormat;

    protected boolean appliedUpdates = false;
    @Nullable protected GenericRow deleteRow;

    public AbstractTableSink(
            TablePath tablePath,
    ...
    public abstract Sink<RowData> sink(
            SinkWriterBuilder<? extends FlinkSinkWriter> sinkWriterBuilder);
    ...
    public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
        ...
        SinkWriterBuilder<? extends FlinkSinkWriter> flinkSinkWriterBuilder =
                (primaryKeyIndexes.length > 0)
                        ? new AbstractSink.UpsertSinkWriterBuilder(
                                tablePath,
                                flussConfig,
                                tableRowType,
                                targetColumnIndexes,
                                ...
                                lakeFormat,
                                shuffleByBucketId)
                        : new AbstractSink.AppendSinkWriterBuilder(
                                tablePath,
                                flussConfig,
                                tableRowType,
                                ignoreDelete,
                                ...
                                lakeFormat,
                                shuffleByBucketId);
        return SinkV2Provider.of(sink(flinkSinkWriterBuilder));
    }
