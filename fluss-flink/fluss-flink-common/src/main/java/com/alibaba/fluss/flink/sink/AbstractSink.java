...
abstract class AbstractSink implements Sink<RowData>, SupportsPreWriteTopology<RowData> {

    private static final long serialVersionUID = 1L;

    protected final SinkWriterBuilder<? extends FlinkSinkWriter> builder;

    AbstractSink(SinkWriterBuilder<? extends FlinkSinkWriter> builder) {
