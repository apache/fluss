...
public class PojoToRowDataConverter<T> {
    ...
    /**
     * Creates a new converter for the specified POJO class and row type. * * @param pojoClass The
     * class of POJOs to convert
     *
    ...
    /**
     * Converts a POJO to a RowData object according to the schema. * * @param pojo The POJO to
     * convert
     *
