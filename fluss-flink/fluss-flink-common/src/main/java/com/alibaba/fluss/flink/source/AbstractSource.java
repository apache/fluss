...
public abstract class AbstractSource<OUT>
    ...
    protected final FlussDeserializationSchema<OUT> deserializationSchema;
    ...
    public abstract SourceReader<OUT, SourceSplitBase> sourceReader(
