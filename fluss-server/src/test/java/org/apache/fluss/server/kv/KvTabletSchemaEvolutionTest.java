...
class KvTabletSchemaEvolutionTest {
    ...
    @Test
    void testConvertTargetColumns_columnNotFoundInTarget() {
        ...
        int[] positions = {0, 2};
        assertThatThrownBy(
                        () -> KvTablet.convertTargetColumns(positions, SCHEMA_V0, schemaWithoutC))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("not found in latest schema");
    }
