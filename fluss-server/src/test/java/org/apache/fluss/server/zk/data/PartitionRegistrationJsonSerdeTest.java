...
class PartitionRegistrationJsonSerdeTest extends JsonSerdeTestBase<PartitionRegistration> {
    ...
    protected PartitionRegistration[] createObjects() {
        ...
        // with remote data dir
        partitionRegistrations[0] =
                new PartitionRegistration(1234L, 5678L, new FsPath("file://local/remote"));

        // without remote data dir
        partitionRegistrations[1] = new PartitionRegistration(1234L, 5678L, null);
    ...
    protected String[] expectedJsons() {
        return new String[] {
            ...
            "{\"version\":1,\"table_id\":1234,\"partition_id\":5678}"
        };
    }
}
