...
public class RemoteLogITCase {
    ...
    void testDynamicLakeEnableAffectsTTL() throws Exception {
        ...
        coordinatorGateway
                .alterTable(
                        newAlterTableRequest(
                                tablePath, ConfigOptions.TABLE_DATALAKE_ENABLED.key(), "true"))
                .get();
        ...
        coordinatorGateway
                .alterTable(
                        newAlterTableRequest(
                                tablePath, ConfigOptions.TABLE_DATALAKE_ENABLED.key(), "false"))
                .get();
    ...
    private static AlterTableRequest newAlterTableRequest(
            TablePath tablePath, String key, String value) {
        AlterTableRequest request = new AlterTableRequest();
        PbAlterConfig alterConfig = new PbAlterConfig();
        alterConfig
                .setConfigKey(key)
                .setConfigValue(value)
                .setOpType(AlterConfigOpType.SET.value());
        request.addAllConfigChanges(Collections.singletonList(alterConfig))
                .setIgnoreIfNotExists(false)
                .setTablePath()
