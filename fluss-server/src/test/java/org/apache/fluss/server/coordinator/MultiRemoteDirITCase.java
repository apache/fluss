...
class MultiRemoteDirITCase {
    ...
    void testCreatePartitionsWithRoundRobin(boolean isPrimaryKeyTable) throws Exception {
        ...
        assertThat(table.remoteDataDir).isNull();
    ...
    @Test
    void test() {
        System.out.println(ConfigOptions.REMOTE_DATA_DIRS_STRATEGY.description());
        System.out.println(ConfigOptions.REMOTE_DATA_DIRS_WEIGHTS.description());
    }
}
