...
public class SchemaUpdate {
    ...
    private final List<String> autoIncColumns;
    ...
    public SchemaUpdate(TableInfo tableInfo) {
        ...
        this.autoIncColumns = tableInfo.getSchema().getAutoIncrementColumnNames();
    ...
    public Schema getSchema() {
        ...
        for (String autoIncColumn : autoIncColumns) {
            builder.enableAutoIncrement(autoIncColumn);
        }
