...
public class CoordinatorContext {
    ...
    /** Returns whether the bucket is indexed for offline-leader recovery. */
    public boolean isOfflineLeaderBucket(TableBucket tableBucket) {
        return offlineLeaderBuckets.contains(tableBucket);
    }
