...
class ShreddingSchemaTest {
    ...
    @Test
    void testGetters() {
        ShreddedField field1 = new ShreddedField("age", new IntType());
        ShreddedField field2 = new ShreddedField("name", new StringType());
        ...
        ShreddingSchema original =
                new ShreddingSchema(
                        ...
                        Arrays.asList(
                                ...
                                new ShreddedField("active", DataTypes.BOOLEAN())));
    ...
    void testEqualsAndHashCode() {
        ShreddingSchema s1 =
                new ShreddingSchema(
                        "event", Arrays.asList(new ShreddedField("age", DataTypes.INT())));
        ShreddingSchema s2 =
                new ShreddingSchema(
                        "event", Arrays.asList(new ShreddedField("age", DataTypes.INT())));
        ShreddingSchema s3 =
                new ShreddingSchema(
                        "other", Arrays.asList(new ShreddedField("age", DataTypes.INT())));
    ...
    void testFieldsListIsUnmodifiable() {
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(
                        () -> schema.getFields().add(new ShreddedField("x", DataTypes.INT())))
