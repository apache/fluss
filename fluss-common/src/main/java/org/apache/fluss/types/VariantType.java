 ...
 * primitives, strings, arrays, and objects (similar to JSON). Internally, variant values are stored
 * using the Parquet Variant Binary Encoding format (metadata dictionary + self-describing value).
 *
 * @since 0.7
 */
@PublicStable
