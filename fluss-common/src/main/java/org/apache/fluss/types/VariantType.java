...
/**
 * Data type of a semi-structured variant value. A variant can represent any JSON-like value with an
 * efficient binary encoding (value + metadata byte arrays).
 *
 * <p>Internally, a variant is stored as a {@code byte[]} containing the binary-encoded value and
 * metadata.
 *
 * @since 0.7
 */
