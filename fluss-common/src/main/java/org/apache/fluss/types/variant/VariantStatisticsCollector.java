...
public class VariantStatisticsCollector {
    ...
    public void collect(Variant variant) {
        ...
        collectTopLevelObjectFields(variant);
    }
    ...
    /**
     * Collects field statistics from top-level object fields.
     *
     * @param variant the object variant to analyze
     */
    private void collectTopLevelObjectFields(Variant variant) {
        // TODO: FIP-36 follow-up: recursively collect nested object paths and array element paths
        // once the API, writer residual pruning, and server-side Arrow projection can all carry
        // structured Variant paths instead of plain top-level field names.
        ...
        for (int i = 0; i < numFields; i++) {
            ...
            String fieldPath = VariantUtil.metadataFieldName(metadata, fieldId);
