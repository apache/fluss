...
public class VariantBuilder {
    ...
    public byte[] buildMetadata() {
        ...
        // METADATA_VERSION=1 | METADATA_SORTED_STRINGS_BIT=0x10 | METADATA_OFFSET_SIZE_BITS=0xC0
        // -> 0xD1
    ...
    private static class JsonParser {
        ...
        private byte[] encodeArray(List<byte[]> elements) {
            ...
            // Header: ARRAY with offset_size=4 (3<<2), is_large=true (1<<6)
            result[0] = (byte) (VariantUtil.BASIC_TYPE_ARRAY | (3 << 2) | (1 << 6));
