...
public class MetricNames {
    ...
    public static final String LOCAL_KV_SNAPSHOT_RESTORES = "localKvSnapshotRestores";
    public static final String LOCAL_KV_SNAPSHOT_FALLBACKS = "localKvSnapshotFallbacks";
