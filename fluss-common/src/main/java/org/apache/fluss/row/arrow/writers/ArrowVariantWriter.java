...
/**
 * {@link ArrowFieldWriter} for Variant type. Serializes {@link Variant} values into a {@link
 * VarBinaryVector} using the Variant binary encoding format (metadata + value).
 */
@Internal
public class ArrowVariantWriter extends ArrowFieldWriter {

    public ArrowVariantWriter(VarBinaryVector varBinaryVector) {
