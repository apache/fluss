...
public interface KeyEncoder {
     ...
     *
     * <p><b>Backward Compatibility:</b> For tables created before the introduction of kv format
     * version (legacy tables without kvFormatVersion), we continue to use the original encoding
    ...
    static KeyEncoder ofPrimaryKeyEncoder(
        ...
        throw new UnsupportedOperationException("Unsupported kv format version: " + version);
    }
