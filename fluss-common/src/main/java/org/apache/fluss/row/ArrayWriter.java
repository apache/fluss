...
public interface ArrayWriter {
    ...
    static ValueSetter createValueSetter(DataType elementType, Serializer<?> serializer) {
        ...
        switch (elementType.getTypeRoot()) {
            ...
            case ARRAY:
                // TODO: Remove serializer dependency - each writer should handle serialization
                final Object arraySerializer = null;
                return (writer, pos, value) ->
                        writer.writeArray(
                                pos,
                                (InternalArray) value,
            ...
            case MAP:
                // TODO: Remove serializer dependency - each writer should handle serialization
                final Object mapSerializer = null;
                return (writer, pos, value) ->
                        writer.writeMap(
                                pos, (InternalMap) value, (InternalMapSerializer) mapSerializer);
            case ROW:
                // TODO: Remove serializer dependency - each writer should handle serialization
                final Object rowSerializer = null;
                return (writer, pos, value) ->
                        writer.writeRow(
