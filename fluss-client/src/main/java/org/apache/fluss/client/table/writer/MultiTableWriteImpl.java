 ...
 *
 * <p>Thin pass-through builder that constructs a {@link MultiTableWriterImpl} bound to the
 * connection's shared {@link org.apache.fluss.client.write.WriterClient}. Tables are registered
 * dynamically on the writer on first {@code write(...)} call &mdash; no upfront declaration is
 * required.
 *
 * @since 0.7
 */
...
public class MultiTableWriteImpl implements MultiTableWrite {
    ...
    public MultiTableWriter createWriter() {
        return new MultiTableWriterImpl(
                ...
                connection.getOrCreateWriterClient());
    }
}
