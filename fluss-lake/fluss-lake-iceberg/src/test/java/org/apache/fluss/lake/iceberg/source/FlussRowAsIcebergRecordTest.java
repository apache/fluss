...
class FlussRowAsIcebergRecordTest {
    ...
    void testMapType() {
        ...
        // Simple Map
        org.apache.fluss.row.GenericMap simpleMap =
        ...
        org.apache.fluss.row.GenericMap nestedMap =
                new org.apache.fluss.row.GenericMap(
                        new java.util.HashMap<Object, Object>() {
                            {
        ...
        // Map in Array
        org.apache.fluss.row.GenericMap arrayMap1 =
                new org.apache.fluss.row.GenericMap(
                        new java.util.HashMap<Object, Object>() {
                            {
        ...
        org.apache.fluss.row.GenericMap arrayMap2 =
                new org.apache.fluss.row.GenericMap(
                        new java.util.HashMap<Object, Object>() {
                            {
