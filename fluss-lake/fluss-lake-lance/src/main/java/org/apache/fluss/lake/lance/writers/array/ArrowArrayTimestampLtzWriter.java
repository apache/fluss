...
/** {@link ArrowFieldWriter} for TimestampLtz elements in arrays. */
public class ArrowArrayTimestampLtzWriter extends ArrowFieldWriter<InternalArray> {
    public static ArrowArrayTimestampLtzWriter forField(ValueVector valueVector, int precision) {
        return new ArrowArrayTimestampLtzWriter(valueVector, precision);
    }

    private final int precision;

    private ArrowArrayTimestampLtzWriter(ValueVector valueVector, int precision) {
        super(valueVector);
        checkState(
    ...
    public void doWrite(InternalArray array, int ordinal, boolean handleSafe) {
        ...
        if (isNullAt(array, ordinal)) {
            ...
            TimestampLtz timestamp = readTimestamp(array, ordinal);
    ...
    private TimestampLtz readTimestamp(InternalArray array, int ordinal) {
        return array.getTimestampLtz(ordinal, precision);
    }
}
