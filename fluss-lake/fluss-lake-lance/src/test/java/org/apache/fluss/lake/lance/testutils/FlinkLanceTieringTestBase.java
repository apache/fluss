...
public class FlinkLanceTieringTestBase {
    ...
    protected long createLogTableWithArrayColumns(TablePath tablePath) throws Exception {
        Schema.Builder schemaBuilder =
                Schema.newBuilder()
    ...
    protected long createLogTableWithVectorColumn(TablePath tablePath) throws Exception {
        Schema.Builder schemaBuilder =
                Schema.newBuilder()
