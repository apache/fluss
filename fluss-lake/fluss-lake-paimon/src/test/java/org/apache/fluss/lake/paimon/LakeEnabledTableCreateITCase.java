...
class LakeEnabledTableCreateITCase {
    ...
    void testEnableLakeTableAfterAlterTableProperties() throws Exception {
        ...
        assertThatThrownBy(
                ...
                .hasMessage(
                        "The options of the existing Paimon table are not compatible with those of the new table to be created. "
                                + "Existing options: {bucket=3, fluss.table.replication.factor=1, fluss.table.datalake.enabled=true, fluss.table.datalake.format=paimon, partition.legacy-name=false, bucket-key=c1,c2, file.format=parquet, fluss.k2=v2}, "
                                + "new options: {bucket=3, fluss.table.replication.factor=1, fluss.table.datalake.enabled=true, fluss.table.datalake.format=paimon, partition.legacy-name=false, bucket-key=c1,c2, file.format=parquet, fluss.k2=v22}.");
    }
