...
When creating your feature request, start by clearly documenting your requirements and avoid jumping straight to implementation details. For substantial features or architectural changes that need broader community input, consider submitting a FIP. Use the local [Contribute FIPs](contribute-fip.md) guide for the recommended flow and link it to the published [Fluss Improvement Proposals](https://cwiki.apache.org/confluence/display/FLUSS/Fluss+Improvement+Proposals) space.
