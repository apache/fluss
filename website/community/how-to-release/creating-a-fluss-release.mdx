...
Once the release has been finalized, wait at least one hour after uploading the new release before updating the project download page or sending the announcement emails, in accordance with the [ASF release policy](https://www.apache.org/legal/release-policy.html#how-should-releases-be-announced).
