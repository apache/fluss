...
| `--database`                           | (one of two)  | Database to clean. Exactly one of `--database` or `--all-databases` is required; the two are mutually exclusive.                                                                                                                                                                    |
| `--all-databases`                      | (one of two)  | Clean every database. Exactly one of `--database` or `--all-databases` is required; the two are mutually exclusive.                                                                                                                                                                 |
