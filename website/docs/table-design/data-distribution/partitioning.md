...
| table.auto-partition.key           | String  | no       | (none)               | The single time partition key which is used as the partition key for auto create partitions. If the table has only one partition key, this config is not necessary. If the table has multiple partition keys, must specify one.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
