...
To enabled HDFS as remote storage, you need to define the hdfs path as remote storage in Fluss' `common.yaml`:
...
To allow for easy adoption, you can use the same configuration keys in Fluss' `common.yaml` as in Hadoop's `core-site.xml`.
