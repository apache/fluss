...
To enabled HDFS as remote storage, you need to setup the hdfs configuration. 

### Configuration Loading Priority

Fluss supports three methods for loading Hadoop configuration, listed in order of priority (highest to lowest):
...
```yaml
# Required: Remote storage of Fluss directory  
remote.data.dir: hdfs://namenode:50010/path/to/remote/storage

# Optional: Remote file system write buffer size (default: 4kb)  
remote.fs.write-buffer-size: 16kb
