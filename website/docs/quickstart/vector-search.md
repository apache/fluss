...
:::note
Vector search, batch query and union read query feature against Lance table are being planned. 

This quickstart shows vector search and vector indexing of Fluss tiered Lance table using PyLance  
:::
