...
class SparkPredicateUtilsTest extends AnyFunSuite {
  ...
  // ---------------------------------------------------------------------------------------------
  // SparkPartitionPredicate.matchesPartition
  // ---------------------------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------------------------
  // SparkPartitionPredicate.extract
  // ---------------------------------------------------------------------------------------------
  ...
  test("extract keeps an unconvertible predicate as non-partition") {
    ...
    val notEq: Predicate = new Not(dtEquals("2026-01-01"))
