...
import org.apache.fluss.spark.procedure.CompactProcedure;
import org.apache.fluss.spark.procedure.Procedure;
import org.apache.fluss.spark.procedure.ProcedureBuilder;
...
public class SparkProcedures {
    ...
    private static Map<String, Supplier<ProcedureBuilder>> initProcedureBuilders() {
        Map<String, Supplier<ProcedureBuilder>> procedureBuilders = new HashMap<>();
        procedureBuilders.put("compact", CompactProcedure::builder);
        return Collections.unmodifiableMap(procedureBuilders);
    }
}
