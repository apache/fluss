...
/**
 * Compatibility test for fluss 0.6 client to connect with different fluss server to do admin, read,
 * write operations.
 */
@Testcontainers
public class Fluss06ClientToServerCompatTest extends ClientToServerCompatTest {
    ...
    void testToFluss07Server() throws Exception {
        clientToServerTestPipeline(FLUSS_06_VERSION_MAGIC, FLUSS_07_VERSION_MAGIC);
    }

    @Test
    void testToFlussLatestServer() throws Exception {
        clientToServerTestPipeline(FLUSS_06_VERSION_MAGIC, FLUSS_LATEST_VERSION_MAGIC);
    }
    ...
    void verifyAlterTable(
        ...
        // do nothing as Fluss-0.6 client does not support alterTable.
    }
    ...
    List<String> listPartitions(
            String dbName, String tableName, Map<String, String> partitionSpec) {
        // do nothing as Fluss-0.6 client does not support listPartitions by spec.
        return null;
    }
    ...
    @Override
    List<TestingAclBinding> listAnyAcls() {
        // do nothing as Fluss-0.6 client does not support listAcls.
        return null;
    }

    @Override
    void createAcl(TestingAclBinding aclBinding) {
        // do nothing as Fluss-0.6 client does not support createAcl.
    }

    @Override
    void dropAllAcls() {
        // do nothing as Fluss-0.6 client does not support dropAcls.
    }

    @Override
    List<TestingConfigEntry> describeClusterConfigs() {
        // do nothing as Fluss-0.6 client does not support describeClusterConfigs.
        return null;
    }

    @Override
    void alterClusterConfig(TestingAlterConfig alterConfig) {
        // do nothing as Fluss-0.6 client does not support alterClusterConfigs.
    }
