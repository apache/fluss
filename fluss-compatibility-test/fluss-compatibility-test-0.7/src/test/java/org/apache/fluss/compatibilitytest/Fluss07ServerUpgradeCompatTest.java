...
/** Compatibility testing for upgrading from fluss-0.7 to different higher versions . */
@Testcontainers
public class Fluss07ServerUpgradeCompatTest extends ServerUpgradeCompatTest {
    ...
    @Test
    void testUpgradeFluss07ServerToLatest() throws Exception {
        serverUpgradeTestPipeline(
                FLUSS_07_VERSION_MAGIC, FLUSS_07_VERSION_MAGIC, FLUSS_LATEST_VERSION_MAGIC);
    }
